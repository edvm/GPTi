...
download_file() {
  ...
  if [ "$OS" == "Linux" ]; then
    download_url="https://github.com/edvm/GPTi/tree/main/docs/releases/linux/gpti"
  elif [ "$OS" == "Mac" ]; then
    download_url="https://github.com/edvm/GPTi/tree/main/docs/releases/mac-arm/gpti"
  fi
